...
We can fit the model described above via the "spot lm" function. The "spot lm" function is a direct analog of the standard lm function in R. 
```{r}
...
We can compute pvalues and qvalues for testing for accessibility differences in oligodendrocytes in the corpus callosum vs the cortex using the "compute contrast significance" function. 
```{r}
